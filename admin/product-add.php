                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="p_name" placeholder="Enter product" class="form-control" value="Product">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="email-input" name="p_title" placeholder="Enter Title" class="form-control" value="Uniqe product of banglasdesh">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="description" id="textarea-input" rows="9" placeholder="Please enter a product Description..." class="form-control">Stay powered up on the go with the SuperCharge 2000X, your ultimate portable charging companion. Boasting a massive 20,000mAh capacity, this sleek power bank can charge your smartphone up to five times or your tablet twice on a single charge. Its dual USB-A and USB-C</textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="number" id="password-input" name="prize" value="50" class="form-control">
